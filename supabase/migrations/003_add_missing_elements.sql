...
CHECK (stage IN ('new', 'warming_up', 'active', 'paused', 'banned'));
...
-- Rename daisy_id to rental_id for consistency
...
-- Rename video_path to asset_path
...
-- 11. Enable RLS on logs table
ALTER TABLE logs ENABLE ROW LEVEL SECURITY;

-- 12. Create RLS policies (since none exist in old schema)
