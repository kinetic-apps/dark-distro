  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-6">
          <div className="card">
            ...
            <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                <dt className="text-sm font-medium text-gray-500">Warm-up Progress</dt>
                <dd className="mt-1">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium">{profile.warmup_progress}%</span>
                  </div>
                </dd>
              </div>
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900">
                  ...
                  {profile.last_error && (
                    <p className="text-xs text-red-600 mt-1">{profile.last_error}</p>
                  )}
                </dd>
              </div>
            </dl>
          ...
          <div className="card">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-medium text-gray-900">Device Info</h2>
              {profile.phone && (
                <span className={`status-badge ${
            ...
            {profile.phone ? (
              ...
              <p className="text-sm text-gray-500">No device assigned</p>
            )}
          </div>
        ...
        <div className="space-y-6">
          <div className="card">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Proxy</h3>
            ...
            {profile.proxy ? (
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">{profile.proxy.type}</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">Current IP</span>
              ...
              <div>
                <p className="text-sm text-gray-500 mb-4">No proxy assigned</p>
